...
<head>
    ...
    <link rel="icon" type="image/vnd.microsoft.icon" href="{{asset('assets/images/favicon.png')}}">
    ...
    <link rel="stylesheet" type="text/css" href="{{asset('assets/css/theme-4527f124.css')}}">
