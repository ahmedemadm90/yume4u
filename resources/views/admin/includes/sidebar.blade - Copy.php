...
<!--
            <li class="nav-item"><a href=""><i class="la la-group"></i>
                ...
                <ul class="menu-content">
                    <li class=""><a class="menu-item" href="{{route('admin.subcategories')}}"
                                          data-i18n="nav.dash.ecommerce"> عرض الكل </a>
                    </li>
...
-->
            ...
            <li class="nav-item"><a href=""><i class="la la-male"></i>
                ...
                <ul class="menu-content">
                    ...
                    <li><a class="menu-item" href="{{route('admin.lotteries.create')}}" data-i18n="nav.dash.crypto">أضافة
                            سحب  </a>
                    </li>
                </ul>
            </li>
            ...
            <li class="nav-item"><a href=""><i class="la la-group"></i>
                ...
                <ul class="menu-content">
                    <li class=""><a class="menu-item" href="{{route('admin.admins')}}"
                                          data-i18n="nav.dash.ecommerce"> عرض الكل </a>
                    </li>
                    <li><a class="menu-item" href="{{route('admin.admins.create')}}" data-i18n="nav.dash.crypto">أضافة وكيل جديد </a>
                    </li>
                </ul>
            </li>
            ...
            <li class="nav-item"><a href=""><i class="la la-group"></i>
                ...
                <ul class="menu-content">
                <li class=""><a class="menu-item" href="{{route('admin.users')}}" data-i18n="nav.dash.ecommerce"> عرض كل المستخدمين </a></li>
                <li class=""><a class="menu-item" href="{{route('admin.users.create')}}" data-i18n="nav.dash.ecommerce"> إضافة مستخدم جديد </a></li>

<hr>
                <li class=""><a class="menu-item" href="{{route('admin.admins')}}" data-i18n="nav.dash.ecommerce"> عرض كل المشرفين </a></li>
                <li class=""><a class="menu-item" href="{{route('admin.admins.create')}}" data-i18n="nav.dash.ecommerce"> إضافة مشرف جديد </a></li>

<hr>

                <li class=""><a class="menu-item" href="{{route('admin.roles')}}" data-i18n="nav.dash.ecommerce"> عرض الأدوار </a></li>
                <li class=""><a class="menu-item" href="{{route('admin.roles.create')}}" data-i18n="nav.dash.ecommerce"> إضافة دور جديد </a></li>
