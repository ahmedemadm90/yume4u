                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a href="{{route('admin.users.delete',$user->id)}}" data-id="{{ $user->id }}"
                                            data-title="{{ $user->name }}" data-image="{{ $user->image }}" id="delete"
                                            class="btn btn-danger"><i data-feather="trash"></i>
                                            {{ trans('Delete') }}</a>
                                    </td>
                                </tr>
                                @endforeach
