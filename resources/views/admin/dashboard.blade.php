...
@section('content')
@php $lotteries = App\Models\Lottery::all(); @endphp
@php $agents = App\Models\User::all(); @endphp
                                ...
                                <div class="card-body pb-0">
                                    <div class="row">
                                        ...
                                        <div class="col-5 text-right">
                                            <h4>{{ $lotteries->count() }}</h4>
                                            <h6 class="success darken-4">100% <i class="la la-arrow-up"></i></h6>
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                            ...
                            <div class="card-content">
                                <div class="card-body pb-0">
                                    <div class="row">
                                        ...
                                        <div class="col-5 text-right">
                                            <h4>{{ $users->count() }}</h4>
                                            <h6 class="danger">100% <i class="la la-arrow-down"></i></h6>
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
