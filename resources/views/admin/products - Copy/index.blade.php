                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <img style="width: 150px; height: 100px;"
                                                        src='{{asset("media/products/$product->images")}}' alt='image'>
                                    ...
                                    <td>
                                        <a href="{{route('admin.products.edit',$product->id)}}" class="btn btn-info"class="btn btn-primary btn-min-width">تعديل</a>
