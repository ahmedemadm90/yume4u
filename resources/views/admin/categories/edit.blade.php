                                    ...
                                    <form class="form" action="{{route('admin.categories.update',$Category->id)}}"
                                        ...
                                        <div class="form-group">
                                            <div class="text-center">
                                                <img src='{{asset("media/$Category->category_name")}}'
                                                ...
                                                <div class="col-md-12">
                                                    <div class="form-group">
                                                        <label for="projectinput1"> اسم القسم
                                                            - {{__('messages.'.$Category->translation_lang)}}
                                                        </label>
                                                ...
                                                {{-- <div class="col-md-6 hidden">
                                                    <div class="form-group">
                                                        <label for="projectinput1"> أختصار
                                                            اللغة {{__('messages.'.$Category->translation_lang)}}
                                                </label>
                                                <input type="text" id="abbr" class="form-control" placeholder="  "
                                                    value="{{$Category->translation_lang}}" name="category[0][abbr]">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group mt-1">
                                            <input type="checkbox" value="1" name="category_state" id="switcheryColor4"
                                                class="switchery" data-color="success" @if($Category->active ==
                                            1)checked @endif/>
