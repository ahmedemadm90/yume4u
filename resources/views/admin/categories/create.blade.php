                            ...
                            <div class="card-content collapse show">
                                <div class="card-body">
                                            ...
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" value="" id="name" class="form-control"
                                                        placeholder="  " name="category[{{$index}}][name]">
                                            ...
                                            <div class="col-md-6 hidden">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" id="abbr" class="form-control" placeholder="  "
                                                        value="{{$lang -> abbr}}" name="category[{{$index}}][abbr]">
                                    ...
                                    <form class="" action="{{route('admin.categories.store')}}" method="POST"
                                        enctype="multipart/form-data">
                                        @csrf
                                        <input class="form-control" placeholder="اسم القسم" name="category_name">
                                        ...
                                        <div class="form-group mt-2">
                                            <input type="file" name="category_img" hidden id="category_img">
                                            <label for="category_img"
                                                class="btn btn-primary">{{__('Category Image')}}</label>
                                        </div>
                                        <div class="form-actions">
