                    ...
                    <div class="col-md-12">
                        <div class="card">
                                    ...
                                    <form class="form" action="{{route('admin.categories.update',$Category->id)}}"
                                        ...
                                        <div class="form-group">
                                            <div class="text-center">
                                                <img src='{{asset("public/media/categories/$Category->category_img")}}'
                                        ...
                                        <select class="form form-control mt-2" name="parent_id">
                                            <option selected hidden disabled>اختر القسم الرئيسي</option>
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group mt-1">
                                            <input type="checkbox" value="1" name="category_state" id="switcheryColor4"
                                                class="switchery" data-color="success" @if($Category->active == 1)checked @endif/>
                            ...
                            <ul class="nav nav-tabs">
                                ...
                                <li class="nav-item">
                                    <a class="nav-link @if($index ==  0) active @endif  " id="homeLable-tab"
                                        data-toggle="tab" href="#homeLable{{$index}}" aria-controls="homeLable"
                            ...
                            <div class="tab-content px-1 pt-1">
                                ...
                                <div role="tabpanel" class="tab-pane  @if($index ==  0) active  @endif  "
                                    ...
                                    <form class="form" action="{{route('admin.categories.update',$translation -> id)}}"
                                        method="POST" enctype="multipart/form-data">
                                        @csrf
                                                ...
                                                <div class="col-md-12">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" id="name" class="form-control"
                                                            placeholder="  " value="{{$translation -> name}}"
