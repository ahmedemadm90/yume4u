...
@section('title')
{{auth()->user()->name}} || {{__('السحوبات المفعلة')}}
@endsection
@section('content')
    ...
    <div class="content-wrapper">
        <div class="content-header row">
            <div class="content-header-left col-md-6 col-12 mb-2">
                <h3 class="content-header-title"> {{trans('السحوبات المفعلة')}} </h3>
                <div class="row breadcrumbs-top">
                    <div class="breadcrumb-wrapper col-12">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="{{route('agent.dashboard')}}">الرئيسية</a>
                            </li>
                            <li class="breadcrumb-item active"> {{trans('السحوبات المفعلة')}}
                            </li>
                        </ol>
                    </div>
                </div>
