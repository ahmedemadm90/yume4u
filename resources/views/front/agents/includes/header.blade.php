                    ...
                    <li class="dropdown dropdown-user nav-item">
                        <a class="dropdown-toggle nav-link dropdown-user-link" href="#" data-toggle="dropdown">
                            ...
                            <span class="avatar avatar-online">
                                ...
                                @else
                                {{asset("media/users/$agent->image")}}
                                @endif
                                " alt="avatar"><i></i></span>
                        </a>
                        <div class="dropdown-menu dropdown-menu-right"><a
                                href="{{route('agent.edit.myinfo',auth()->user()->id)}}" class="dropdown-item"
                                href=""><i class="ft-user"></i> تعديل الملف الشحصي </a>
                            <div class="dropdown-divider"></div>
                            <div class="text-danger text-center">
                                <span>{{auth()->user()->invitation_code}}</span>
                            </div>
                            <div class="dropdown-divider"></div>
                            <a class="dropdown-item" href="{{route('agent.logout')}}"><i class="ft-power"></i>
                                تسجيل
                                الخروج </a>
                        </div>
                    </li>
