    ...
    <div class="content-wrapper">
        ...
        <div class="col-md-12 col-xl-12">
            <div class="card">
                ...
                <form action="{{route('user.updateInfo',$user->id)}}" enctype="multipart/form-data" method="POST">
                    @csrf
                    @include('admin.includes.alerts.success')
                    @include('admin.includes.alerts.errors')
                    <div class="card-body">
                        <div class="row text-center">
                            <img class="img card-img-top m-auto" src='{{asset("media/users/$user->image")}}'
                                style=" width: 100px">
                        </div>
                        <div class="row m-2">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="email" class="form-control" id="email"
                                placeholder="{{ trans('البريد الالكتروني') }}" value="{{$user->email}}">
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <input type="password" name="confirm_password" class="form-control" id="name"
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" name="mobile" class="form-control" id="price"
                                placeholder="{{ trans('رقم التليفون') }}" value="{{$user->mobile}}">
                        </div>
