            ...
            <ul class="nav navbar-nav flex-row">
                ...
                <li class="nav-item">
                    <a class="navbar-brand" href="{{ url('/admin') }}">
                        <img class="brand-logo" alt="modern admin logo" src="{{asset('assets/images/favicon.png')}}">
                        <h3 class="brand-text">Yume Admin</h3>
                    </a>
                </li>
                    ...
                    <li class="dropdown dropdown-user nav-item">
                        <a class="dropdown-toggle nav-link dropdown-user-link" href="#" data-toggle="dropdown">
                            ...
                            <span class="avatar avatar-online">
                                <img class="img card-img-top m-auto" src="@if(!isset(auth()->user()->images))
                        ...
                        <div class="dropdown-menu dropdown-menu-right"><a
                                href="{{route('user.editInfo',auth()->user()->id)}}" class="dropdown-item" href=""><i
                                    class="ft-user"></i> {{trans('تعديل الملف الشحصي')}} </a>
                            <div class="dropdown-divider"></div>
                            <div class="text-danger">
                                <span>Invitation Code : {{auth()->user()->invitaion_code}}</span>
                            </div>
                            <div class="dropdown-divider"></div>
                            <a class="dropdown-item" href="{{route('member.logout')}}"><i class="ft-power"></i>
                                تسجيل
                                الخروج </a>
                        </div>
                    </li>
