        ...
        <section id="content" class="page-home pagehome-three">
            <div class="container">
                <div class="row">
                    ...
                    @include('front.includes.banners-up')

                    
                        </div></div>
                        
                        @include('front.includes.lotterieshot')


                        @include('front.includes.lotterieslist')



                        @include('front.includes.banners-dn')
                        ...
                        @include('front.includes.agents')
                        @include('front.includes.winners')
